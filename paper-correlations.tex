...
Correlation functions of XCT images can be seen on \cref{fig:real-xct} and
correlation functions of SEM images are on
\cref{fig:real-sem}. Cross-correlation functions for a multiphase XCT image is
on \cref{fig:real-multiphase}. Correlation maps for one of SEM samples are of
\cref{fig:real-sem-map}.
