...
Our code is capable of evaluating two-point probability $S_2$, cluster $C_2$, lineal-path $L_2$, surface-surface $F_ss$,
surface-void $F_sv$, pore-size $P$ and chord-length $p$ functions on both CPU and GPU architectures.
