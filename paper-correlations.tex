...
octaves $o = 5$ and a random seed $s = 34365$. The particular implementation for
our measurements was taken from \code{ValueNoise.jl} package. An example of a
two-dimensional image generated in this way is on \cref{fig:valuenoise}.
...
provided in \code{CUDA.FFT} package. We provide execution times for bot CPU and
