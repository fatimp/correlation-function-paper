...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.9\linewidth]{images/figa1.jpg}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.9\linewidth]{images/figa_direction.jpg}
...
Correlation functions of XCT images can be seen on \cref{fig:real-xct} and correlation functions of SEM images are on
\cref{fig:real-sem}. Cross-correlation functions for a multiphase XCT image is on \cref{fig:real-multiphase}.
...
and directional linear scan. Directional CFs are extremely useful in describing or reconstructing
...
computational framework in the form of \code{CorrelationFunctions.jl} package will facilitate research in these areas.
...
clusterization on GPUs
Numerous directions or solid angle
