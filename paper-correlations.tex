...
statistical descriptors of structure of porous media used in many scientific
field such as astronomy, soil physics, hydrology and biology. We propose an open
source and cross-platform solution for computation of vast majority of
correlation functions for both 2D and 3D images of porous material. \\
{\em Solution method:} Our package computes correlation functions using fast
Fourier transform using such preprocessing steps as cluster labeling or edge
detection if needed. Almost all of proposed algorithms can be executed on both
CPU and GPU which results in high execution speed on modern hardware. Two
approaches to evaluation of correlation functions are proposed: computation of
correlation maps and computation along predefined directions. These two
approaches can be thought of as an execution time - memory trade-off. \\
\end{small}
