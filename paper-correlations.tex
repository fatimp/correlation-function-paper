...
\end{equation}
For distance transform has many implementations \textcolor{red}{cite
  something}. In \code{chord\_length} function we firstly apply distance
transform to an input to find the interface and then accumulate chord length in
per-slice manner. Finally, chord lengths can be binned in a histogram.
\begin{algorithmic}[1]
