...
\author[Smith]{Marina~Karsanina}
\author[Smith]{Aleksey~Khlyupin}
\author[Smith]{Kirill~Gerke}
\ead{kg@ifz.ru}
...
\cref{fig:real-sem}. Cross-correlation funcions for a multiphase XCT image is on
\cref{fig:real-multiphase}.
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.45\linewidth]{images/timing-image.png}
