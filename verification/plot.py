...
plt.figure(figsize = (10, 8), dpi = 300)
plt.rc('font', size = 25)
plt.hist(ps_hist_2d, density = True, bins = 20, alpha = 0.5)
plt.hist(ps_hist_3d, density = True, bins = 20, alpha = 0.5)
...
plt.figure(figsize = (10, 8), dpi = 300)
plt.rc('font', size = 25)
plt.hist(cl_hist_2d, density = True, bins = 20, alpha = 0.5)
plt.hist(cl_hist_3d, density = True, bins = 20, alpha = 0.5)
